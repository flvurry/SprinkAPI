...
app.get("/", (req, res) => {
  return res.json({
    error:
      "you bumped into an error! please make sure you have the URL set correctly."
  });
});

client.on("ready", () => {
  client.user.setActivity("Sprinklify Bakery", {
    type: "STREAMING",
    url: "https://www.twitch.tv/ROBLOX"
  });
  console.log("Sprinklify API | Now Online");
});
